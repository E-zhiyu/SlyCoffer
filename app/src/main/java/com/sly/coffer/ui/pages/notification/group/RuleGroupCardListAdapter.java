...
public class RuleGroupCardListAdapter extends ListAdapter<NotificationRuleGroupUnionModel, RuleGroupCardListAdapter.ItemViewHolder> {
    private static final DiffUtil.ItemCallback<NotificationRuleGroupUnionModel> ITEM_CALLBACK = new DiffUtil.ItemCallback<>() {
        @Override
    ...
    private final AdapterOnClickListener<NotificationRuleGroupUnionModel> clickListener;
    private final AdapterOnLongClickListener<NotificationRuleGroupUnionModel> longClickListener;
    ...
    public RuleGroupCardListAdapter(AdapterOnClickListener<NotificationRuleGroupUnionModel> clickListener, AdapterOnLongClickListener<NotificationRuleGroupUnionModel> longClickListener) {
        super(ITEM_CALLBACK);
