 ...
 * 通知规则分组选择对话框中的列表适配器
 */
public class RuleGroupSelectListAdapter extends ListAdapter<NotificationRuleGroupListUnionModel, RuleGroupSelectListAdapter.ItemViewHolder> {
     ...
     */
    RuleGroupSelectListAdapter(@Nullable Set<Long> initCheckSet, AdapterOnChipCheckedChangeListener<NotificationRuleGroupListUnionModel> checkedChangeListener) {
        super(ITEM_CALLBACK);
